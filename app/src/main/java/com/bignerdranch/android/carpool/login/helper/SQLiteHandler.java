package com.bignerdranch.android.carpool.login.helper;

/**
 * Created by Jal on 11/22/15.
 */
...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    /**
     * Storing role details in database
     * */
    public void addRole(String role) {
        ...
        Log.d(TAG, "New role inserted into sqlite: " + id);
    }
    ...
    public void addLocation(String longitude, String latitude) {
        ...
        ContentValues values = new ContentValues();
        values.put(KEY_LONGITUDE, longitude); // Name
